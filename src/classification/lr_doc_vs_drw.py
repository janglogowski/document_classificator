...
level  = "level3"         # choose level1/level2/level3
...
#--- output model folder from your lr_doc_vs_drw config key ---#
...
#--- collect up to 100 random docs per subfolder ---#
docs_paths = []
